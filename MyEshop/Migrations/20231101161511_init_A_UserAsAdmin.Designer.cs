...
namespace MyEshop.Migrations
{
    ...
    [Migration("20231101161511_init_A_UserAsAdmin")]
    partial class init_A_UserAsAdmin
    {
            ...
            modelBuilder.Entity("MyEshop.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            CreateDate = new DateTime(2023, 11, 1, 19, 45, 11, 201, DateTimeKind.Local).AddTicks(1477),
                            IsFinaly = false,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("MyEshop.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            Password = "123",
                            RegisterDate = new DateTime(2023, 11, 1, 19, 45, 11, 200, DateTimeKind.Local).AddTicks(2643)
                        });
                });
